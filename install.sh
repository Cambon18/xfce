...
trizen --noconfirm -Sy thunar xdg-user-dirs gvfs gvfs-smb thunar-volman thunar-archive-plugin file-roller gnome-disk-utility mousepad vlc atril ristretto galculator xfce4-terminal gnome-mines libreoffice-fresh firefox-i18n-es-es firefox-adblock-plus cups system-config-printer blueberry
