#!/bin/bash
trizen --noconfirm -Sy lightdm lightdm-gtk-greeter light-locker materia-gtk-theme xfce4-whiskermenu-plugin xfce4-session xfce4-panel xfce4-power-manager xfce4-settings xfce4-screenshooter xfconf xfdesktop xfwm4 network-manager-applet xfce4-pulseaudio-plugin pulseaudio pulseaudio-jack pulseaudio-bluetooth pavucontrol mugshot arc-gtk-theme papirus-icon-theme && \
